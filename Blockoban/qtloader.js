...
function QtLoader(config)
{
    ...
    function loadEmscriptenModule(applicationName) {
        ...
        let applicationId = localStorage.getItem(`${applicationName}_id`);
        if(applicationId == undefined) {
            applicationId = Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15);
            localStorage.setItem(`${applicationName}_id`,applicationId)
        }
    ...
    function completeLoadEmscriptenModule(applicationName, emscriptenModuleSource, wasmModule) {
        ...
        window.qtApplicationUid = localStorage.getItem(`${applicationName}_id`);

        Module["mountsyncFS"] = function () {
            ...
            FS.syncfs(true, function (err) {
                ...
                removeRunDependency("mountsyncFS");
            });
        }
