...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 13890096,
    DYNAMIC_BASE = 19132976,
    DYNAMICTOP_PTR = 13889936;
...
var wasmBinaryFile = 'Blockoban.wasm';
...
var ASM_CONSTS = {
  5204124: function() {if(Module.mainLoopSet){ throw 'Nested event loops is not supported'; }else { Module.mainLoopSet = true; }},  
 10437696: function() {FS.unmount('/home/web_user');},  
 11784691: function() {FS.syncfs(false, function(err) { });},  
 11801825: function() {FS.syncfs(false, function(err) { if(err){ Module.print(err); Module.syncdone = -1; }else{ Module.syncdone = 2; } FS.unmount('/home/web_user'); });}
};
...
// STATICTOP = STATIC_BASE + 13889072;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 13890000, 4), 13890000);function _gmtime_r(time, tmPtr) {
...
var dynCall_iff = Module["dynCall_iff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iff"].apply(null, arguments)
};
...
var dynCall_viiffiif = Module["dynCall_viiffiif"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiffiif"].apply(null, arguments)
};
...
var dynCall_viiiiiijji = Module["dynCall_viiiiiijji"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiiiiijji"].apply(null, arguments)
};
