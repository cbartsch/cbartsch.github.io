...
var wasmBinaryFile;
  wasmBinaryFile = 'appBlockoban.wasm';
...
function qt_asyncify_resume_js() { let wakeUp = Module.qtAsyncifyWakeUp; if (wakeUp == undefined) return; Module.qtAsyncifyWakeUp = undefined; const suspendId = Module.qtSuspendId; setTimeout(() => { if (Module.qtSuspendId !== suspendId) return; wakeUp(); }); }
  ...
  function ___syscall_fallocate(fd, mode, /** @type {!BigInt} */ offset, /** @type {!BigInt} */ len) {
  try {
  
      offset = bigintToI53Checked(offset); if (isNaN(offset)) return -61;
      len = bigintToI53Checked(len); if (isNaN(len)) return -61;
...
var ___start_em_js = Module['___start_em_js'] = 15406172;
var ___stop_em_js = Module['___stop_em_js'] = 15406654;
